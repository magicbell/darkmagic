import { ComponentProps, createStitches, CSS as StitchesCSS, VariantProps } from '@stitches/react';
...
type Stitches = typeof stitches;

export type CSS = StitchesCSS<Stitches>;
export type { ComponentProps, VariantProps };

// Exporting the variables like this instead of export { } = createStitches
// somehow results in better type annotations in the consuming lib.
